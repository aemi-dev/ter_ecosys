...
class DeerParser(object):
    ...
    def INPUT(self):
        ...
        if (4012084833292409859, start_pos_591) in self._p_memoized:
            result, self.pos = self._p_memoized[(4012084833292409859, self.pos)]
        else:
            result = self.NL()
            self._p_memoized[(4012084833292409859, start_pos_591)] = result, self.pos
        ...
        if result is self.NoMatch:
            ...
            if (5861821283808210711, start_pos_593) in self._p_memoized:
                result, self.pos = self._p_memoized[(5861821283808210711, self.pos)]
            else:
                result = self.spec()
                self._p_memoized[(5861821283808210711, start_pos_593)] = result, self.pos
            args['spec'] = result
            if result is self.NoMatch:
                results_596 = self.NoMatch
                self.p_restore()
                ...
                if (-5580043393904734537, start_pos_595) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-5580043393904734537, self.pos)]
                else:
                    result = self.EOF()
                    self._p_memoized[(-5580043393904734537, start_pos_595)] = result, self.pos
                if result is self.NoMatch:
                    results_596 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def NL(self):
        ...
        while 42:
            ...
            if (9002684161949020702, start_pos_598) in self._p_memoized:
                result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
            else:
                result = self._()
                self._p_memoized[(9002684161949020702, start_pos_598)] = result, self.pos
            if result is self.NoMatch:
                ...
                if result is self.NoMatch:
                    ...
                    if result is self.NoMatch:
                        ...
                        if (9002684161949020702, start_pos_602) in self._p_memoized:
                            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                        else:
                            result = self._()
                            self._p_memoized[(9002684161949020702, start_pos_602)] = result, self.pos
                        if result is self.NoMatch:
                            results_603 = self.NoMatch
                            self.p_restore()
                            if self._p_error_stack:
    ...
    def AT(self):
        ...
        if (9002684161949020702, start_pos_606) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_606)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_608) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_608)] = result, self.pos
                if result is self.NoMatch:
                    results_609 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def LP(self):
        ...
        if (9002684161949020702, start_pos_611) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_611)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_613) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_613)] = result, self.pos
                if result is self.NoMatch:
                    results_614 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def RP(self):
        ...
        if (9002684161949020702, start_pos_616) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_616)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_618) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_618)] = result, self.pos
                if result is self.NoMatch:
                    results_619 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def LSB(self):
        ...
        if (9002684161949020702, start_pos_621) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_621)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_623) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_623)] = result, self.pos
                if result is self.NoMatch:
                    results_624 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def RSB(self):
        ...
        if (9002684161949020702, start_pos_626) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_626)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_628) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_628)] = result, self.pos
                if result is self.NoMatch:
                    results_629 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def LCB(self):
        ...
        if (9002684161949020702, start_pos_631) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_631)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_633) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_633)] = result, self.pos
                if result is self.NoMatch:
                    results_634 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def RCB(self):
        ...
        if (9002684161949020702, start_pos_636) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_636)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_638) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_638)] = result, self.pos
                if result is self.NoMatch:
                    results_639 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def TILDA(self):
        ...
        if (9002684161949020702, start_pos_641) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_641)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_643) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_643)] = result, self.pos
                if result is self.NoMatch:
                    results_644 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def STAR(self):
        ...
        if (9002684161949020702, start_pos_646) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_646)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_648) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_648)] = result, self.pos
                if result is self.NoMatch:
                    results_649 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def COMMA(self):
        ...
        if (9002684161949020702, start_pos_651) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_651)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_653) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_653)] = result, self.pos
                if result is self.NoMatch:
                    results_654 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def COLON(self):
        ...
        if (9002684161949020702, start_pos_656) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_656)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_658) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_658)] = result, self.pos
                if result is self.NoMatch:
                    results_659 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def INDENT(self):
        ...
        if (9002684161949020702, start_pos_661) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_661)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (4012084833292409859, start_pos_663) in self._p_memoized:
                    result, self.pos = self._p_memoized[(4012084833292409859, self.pos)]
                else:
                    result = self.NL()
                    self._p_memoized[(4012084833292409859, start_pos_663)] = result, self.pos
                result = "" if result is self.NoMatch else result
                if result is self.NoMatch:
                    # print self._p_error_stack
                    self._p_error_stack.pop()
                if result is self.NoMatch:
                    ...
                    if (9002684161949020702, start_pos_665) in self._p_memoized:
                        result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                    else:
                        result = self._()
                        self._p_memoized[(9002684161949020702, start_pos_665)] = result, self.pos
                    if result is self.NoMatch:
                        results_666 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def DEDENT(self):
        ...
        if (9002684161949020702, start_pos_668) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_668)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (4012084833292409859, start_pos_670) in self._p_memoized:
                    result, self.pos = self._p_memoized[(4012084833292409859, self.pos)]
                else:
                    result = self.NL()
                    self._p_memoized[(4012084833292409859, start_pos_670)] = result, self.pos
                result = "" if result is self.NoMatch else result
                if result is self.NoMatch:
                    # print self._p_error_stack
                    self._p_error_stack.pop()
                if result is self.NoMatch:
                    ...
                    if (9002684161949020702, start_pos_672) in self._p_memoized:
                        result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                    else:
                        result = self._()
                        self._p_memoized[(9002684161949020702, start_pos_672)] = result, self.pos
                    if result is self.NoMatch:
                        results_673 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def NUMBER(self):
        ...
        if (9002684161949020702, start_pos_681) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_681)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_684) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_684)] = result, self.pos
                if result is self.NoMatch:
                    results_688 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
                    ...
                    if result is self.NoMatch:
                        ...
                        if (9002684161949020702, start_pos_687) in self._p_memoized:
                            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                        else:
                            result = self._()
                            self._p_memoized[(9002684161949020702, start_pos_687)] = result, self.pos
                        if result is self.NoMatch:
                            results_688 = self.NoMatch
                            self.p_restore()
                            if self._p_error_stack:
    ...
    def NAME(self):
        ...
        if (9002684161949020702, start_pos_690) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_690)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if result is self.NoMatch:
                    ...
                    if (9002684161949020702, start_pos_694) in self._p_memoized:
                        result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                    else:
                        result = self._()
                        self._p_memoized[(9002684161949020702, start_pos_694)] = result, self.pos
                    if result is self.NoMatch:
                        results_695 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def spec(self):
        ...
        while 42:
            ...
            if (-3687545176485823941, start_pos_697) in self._p_memoized:
                result, self.pos = self._p_memoized[(-3687545176485823941, self.pos)]
            else:
                result = self.locdef()
                self._p_memoized[(-3687545176485823941, start_pos_697)] = result, self.pos
            if result is not self.NoMatch:
        ...
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (2278222470595315128, start_pos_700) in self._p_memoized:
                    result, self.pos = self._p_memoized[(2278222470595315128, self.pos)]
                else:
                    result = self.instance()
                    self._p_memoized[(2278222470595315128, start_pos_700)] = result, self.pos
                if result is not self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (-185500931860644373, start_pos_703) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-185500931860644373, self.pos)]
                else:
                    result = self.graph()
                    self._p_memoized[(-185500931860644373, start_pos_703)] = result, self.pos
                args['graph'] = result
                if result is self.NoMatch:
                    results_705 = self.NoMatch
                    self.p_restore()
    ...
    def locdef(self):
        ...
        if (-8759996476042128499, start_pos_707) in self._p_memoized:
            result, self.pos = self._p_memoized[(-8759996476042128499, self.pos)]
        else:
            result = self.AT()
            self._p_memoized[(-8759996476042128499, start_pos_707)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (898397525525335440, start_pos_708) in self._p_memoized:
                result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
            else:
                result = self.NAME()
                self._p_memoized[(898397525525335440, start_pos_708)] = result, self.pos
            args['name'] = result
            if result is self.NoMatch:
                results_724 = self.NoMatch
                self.p_restore()
                ...
                if (-261095102150264832, start_pos_710) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-261095102150264832, self.pos)]
                else:
                    result = self.labels()
                    self._p_memoized[(-261095102150264832, start_pos_710)] = result, self.pos
                result = "" if result is self.NoMatch else result
                if result is self.NoMatch:
                    # print self._p_error_stack
                    self._p_error_stack.pop()
                ...
                if result is self.NoMatch:
                    ...
                    if (-3925783393829827877, start_pos_713) in self._p_memoized:
                        result, self.pos = self._p_memoized[(-3925783393829827877, self.pos)]
                    else:
                        result = self.LP()
                        self._p_memoized[(-3925783393829827877, start_pos_713)] = result, self.pos
                    if result is self.NoMatch:
                        results_724 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
                        ...
                        if (7089161770338230791, start_pos_714) in self._p_memoized:
                            result, self.pos = self._p_memoized[(7089161770338230791, self.pos)]
                        else:
                            result = self.params()
                            self._p_memoized[(7089161770338230791, start_pos_714)] = result, self.pos
                        result = "" if result is self.NoMatch else result
                        if result is self.NoMatch:
                            # print self._p_error_stack
                            self._p_error_stack.pop()
                        ...
                        if result is self.NoMatch:
                            ...
                            if (-524458831725247941, start_pos_717) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-524458831725247941, self.pos)]
                            else:
                                result = self.RP()
                                self._p_memoized[(-524458831725247941, start_pos_717)] = result, self.pos
                            if result is self.NoMatch:
                                results_724 = self.NoMatch
                                self.p_restore()
                                if self._p_error_stack:
                                ...
                                if (6629249187153659053, start_pos_718) in self._p_memoized:
                                    result, self.pos = self._p_memoized[(6629249187153659053, self.pos)]
                                else:
                                    result = self.COLON()
                                    self._p_memoized[(6629249187153659053, start_pos_718)] = result, self.pos
                                if result is self.NoMatch:
                                    results_724 = self.NoMatch
                                    self.p_restore()
                                    if self._p_error_stack:
                                    ...
                                    if (4012084833292409859, start_pos_719) in self._p_memoized:
                                        result, self.pos = self._p_memoized[(4012084833292409859, self.pos)]
                                    else:
                                        result = self.NL()
                                        self._p_memoized[(4012084833292409859, start_pos_719)] = result, self.pos
                                    if result is self.NoMatch:
                                        results_724 = self.NoMatch
                                        self.p_restore()
                                        if self._p_error_stack:
                                        ...
                                        if (-3095722118447709365, start_pos_720) in self._p_memoized:
                                            result, self.pos = self._p_memoized[(-3095722118447709365, self.pos)]
                                        else:
                                            result = self.INDENT()
                                            self._p_memoized[(-3095722118447709365, start_pos_720)] = result, self.pos
                                        if result is self.NoMatch:
                                            results_724 = self.NoMatch
                                            self.p_restore()
                                            if self._p_error_stack:
                                            ...
                                            if (-4141903246990413784, start_pos_721) in self._p_memoized:
                                                result, self.pos = self._p_memoized[(-4141903246990413784, self.pos)]
                                            else:
                                                result = self.location()
                                                self._p_memoized[(-4141903246990413784, start_pos_721)] = result, self.pos
                                            ...
                                            if result is self.NoMatch:
                                                ...
                                                if (-5965068941119489108, start_pos_723) in self._p_memoized:
                                                    result, self.pos = self._p_memoized[(-5965068941119489108, self.pos)]
                                                else:
                                                    result = self.DEDENT()
                                                    self._p_memoized[(-5965068941119489108, start_pos_723)] = result, self.pos
                                                if result is self.NoMatch:
                                                    results_724 = self.NoMatch
                                                    self.p_restore()
                                                    if self._p_error_stack:
    ...
    def location(self):
        ...
        while 42:
            ...
            if (-1081191404239552095, start_pos_726) in self._p_memoized:
                result, self.pos = self._p_memoized[(-1081191404239552095, self.pos)]
            else:
                result = self.vardef()
                self._p_memoized[(-1081191404239552095, start_pos_726)] = result, self.pos
            if result is not self.NoMatch:
        ...
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (-5647587001557775935, start_pos_729) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-5647587001557775935, self.pos)]
                else:
                    result = self.rule()
                    self._p_memoized[(-5647587001557775935, start_pos_729)] = result, self.pos
                if result is not self.NoMatch:
    ...
    def params(self):
        ...
        if (898397525525335440, start_pos_734) in self._p_memoized:
            result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
        else:
            result = self.NAME()
            self._p_memoized[(898397525525335440, start_pos_734)] = result, self.pos
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (-826960683912196086, start_pos_735) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-826960683912196086, self.pos)]
                else:
                    result = self.COMMA()
                    self._p_memoized[(-826960683912196086, start_pos_735)] = result, self.pos
                if result is self.NoMatch:
                    ...
                    if (898397525525335440, start_pos_736) in self._p_memoized:
                        result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
                    else:
                        result = self.NAME()
                        self._p_memoized[(898397525525335440, start_pos_736)] = result, self.pos
                    if result is self.NoMatch:
                        results_737 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def labels(self):
        ...
        if (8940689054090519499, start_pos_741) in self._p_memoized:
            result, self.pos = self._p_memoized[(8940689054090519499, self.pos)]
        else:
            result = self.LCB()
            self._p_memoized[(8940689054090519499, start_pos_741)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (7561541381562460085, start_pos_742) in self._p_memoized:
                result, self.pos = self._p_memoized[(7561541381562460085, self.pos)]
            else:
                result = self.arguments()
                self._p_memoized[(7561541381562460085, start_pos_742)] = result, self.pos
            result = "" if result is self.NoMatch else result
            if result is self.NoMatch:
                # print self._p_error_stack
                self._p_error_stack.pop()
            ...
            if result is self.NoMatch:
                ...
                if (5069023775497208902, start_pos_745) in self._p_memoized:
                    result, self.pos = self._p_memoized[(5069023775497208902, self.pos)]
                else:
                    result = self.RCB()
                    self._p_memoized[(5069023775497208902, start_pos_745)] = result, self.pos
                if result is self.NoMatch:
                    results_746 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def arguments(self):
        ...
        if (7368162533318854580, start_pos_748) in self._p_memoized:
            result, self.pos = self._p_memoized[(7368162533318854580, self.pos)]
        else:
            result = self.arg()
            self._p_memoized[(7368162533318854580, start_pos_748)] = result, self.pos
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (-826960683912196086, start_pos_749) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-826960683912196086, self.pos)]
                else:
                    result = self.COMMA()
                    self._p_memoized[(-826960683912196086, start_pos_749)] = result, self.pos
                if result is self.NoMatch:
                    ...
                    if (7368162533318854580, start_pos_750) in self._p_memoized:
                        result, self.pos = self._p_memoized[(7368162533318854580, self.pos)]
                    else:
                        result = self.arg()
                        self._p_memoized[(7368162533318854580, start_pos_750)] = result, self.pos
                    if result is self.NoMatch:
                        results_751 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def arg(self):
        ...
        if (-9066087360609002440, start_pos_755) in self._p_memoized:
            result, self.pos = self._p_memoized[(-9066087360609002440, self.pos)]
        else:
            result = self.NUMBER()
            self._p_memoized[(-9066087360609002440, start_pos_755)] = result, self.pos
        if result is self.NoMatch:
            start_pos_756= self.pos
            if (898397525525335440, start_pos_756) in self._p_memoized:
                result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
            else:
                result = self.NAME()
                self._p_memoized[(898397525525335440, start_pos_756)] = result, self.pos
            if result is self.NoMatch:
                pass
        if result is self.NoMatch:
            self.p_restore()
    ...
    def vardef(self):
        ...
        if (898397525525335440, start_pos_759) in self._p_memoized:
            result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
        else:
            result = self.NAME()
            self._p_memoized[(898397525525335440, start_pos_759)] = result, self.pos
        args['name'] = result
        if result is self.NoMatch:
            ...
            if (-8095235216294791788, start_pos_761) in self._p_memoized:
                result, self.pos = self._p_memoized[(-8095235216294791788, self.pos)]
            else:
                result = self.boundaries()
                self._p_memoized[(-8095235216294791788, start_pos_761)] = result, self.pos
            result = "" if result is self.NoMatch else result
            if result is self.NoMatch:
                # print self._p_error_stack
                self._p_error_stack.pop()
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_764) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_764)] = result, self.pos
                if result is self.NoMatch:
                    results_770 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
                    ...
                    if result is self.NoMatch:
                        ...
                        if (9002684161949020702, start_pos_766) in self._p_memoized:
                            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                        else:
                            result = self._()
                            self._p_memoized[(9002684161949020702, start_pos_766)] = result, self.pos
                        if result is self.NoMatch:
                            results_770 = self.NoMatch
                            self.p_restore()
                            if self._p_error_stack:
                            ...
                            if (-8118700143328859462, start_pos_767) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-8118700143328859462, self.pos)]
                            else:
                                result = self.expr()
                                self._p_memoized[(-8118700143328859462, start_pos_767)] = result, self.pos
                            args['init'] = result
                            if result is self.NoMatch:
                                results_770 = self.NoMatch
                                self.p_restore()
                                ...
                                if (4012084833292409859, start_pos_769) in self._p_memoized:
                                    result, self.pos = self._p_memoized[(4012084833292409859, self.pos)]
                                else:
                                    result = self.NL()
                                    self._p_memoized[(4012084833292409859, start_pos_769)] = result, self.pos
                                if result is self.NoMatch:
                                    results_770 = self.NoMatch
                                    self.p_restore()
                                    if self._p_error_stack:
    ...
    def boundaries(self):
        ...
        if (6629249187153659053, start_pos_772) in self._p_memoized:
            result, self.pos = self._p_memoized[(6629249187153659053, self.pos)]
        else:
            result = self.COLON()
            self._p_memoized[(6629249187153659053, start_pos_772)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (-9066087360609002440, start_pos_773) in self._p_memoized:
                result, self.pos = self._p_memoized[(-9066087360609002440, self.pos)]
            else:
                result = self.NUMBER()
                self._p_memoized[(-9066087360609002440, start_pos_773)] = result, self.pos
            args['lower'] = result
            if result is self.NoMatch:
                results_780 = self.NoMatch
                self.p_restore()
                ...
                if (9002684161949020702, start_pos_775) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_775)] = result, self.pos
                if result is self.NoMatch:
                    results_780 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
                    ...
                    if result is self.NoMatch:
                        ...
                        if (9002684161949020702, start_pos_777) in self._p_memoized:
                            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                        else:
                            result = self._()
                            self._p_memoized[(9002684161949020702, start_pos_777)] = result, self.pos
                        if result is self.NoMatch:
                            results_780 = self.NoMatch
                            self.p_restore()
                            if self._p_error_stack:
                            ...
                            if (-9066087360609002440, start_pos_778) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-9066087360609002440, self.pos)]
                            else:
                                result = self.NUMBER()
                                self._p_memoized[(-9066087360609002440, start_pos_778)] = result, self.pos
                            args['upper'] = result
                            if result is self.NoMatch:
                                results_780 = self.NoMatch
                                self.p_restore()
    ...
    def rule(self):
        ...
        if (-4789792593941748353, start_pos_782) in self._p_memoized:
            result, self.pos = self._p_memoized[(-4789792593941748353, self.pos)]
        else:
            result = self.conditions()
            self._p_memoized[(-4789792593941748353, start_pos_782)] = result, self.pos
        ...
        if result is self.NoMatch:
            ...
            if (9002684161949020702, start_pos_784) in self._p_memoized:
                result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
            else:
                result = self._()
                self._p_memoized[(9002684161949020702, start_pos_784)] = result, self.pos
            if result is self.NoMatch:
                results_793 = self.NoMatch
                self.p_restore()
                if self._p_error_stack:
                ...
                if result is self.NoMatch:
                    ...
                    if (9002684161949020702, start_pos_789) in self._p_memoized:
                        result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                    else:
                        result = self._()
                        self._p_memoized[(9002684161949020702, start_pos_789)] = result, self.pos
                    if result is self.NoMatch:
                        results_793 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
                        ...
                        if (3018302413635106851, start_pos_790) in self._p_memoized:
                            result, self.pos = self._p_memoized[(3018302413635106851, self.pos)]
                        else:
                            result = self.assignments()
                            self._p_memoized[(3018302413635106851, start_pos_790)] = result, self.pos
                        ...
                        if result is self.NoMatch:
                            ...
                            if (4012084833292409859, start_pos_792) in self._p_memoized:
                                result, self.pos = self._p_memoized[(4012084833292409859, self.pos)]
                            else:
                                result = self.NL()
                                self._p_memoized[(4012084833292409859, start_pos_792)] = result, self.pos
                            if result is self.NoMatch:
                                results_793 = self.NoMatch
                                self.p_restore()
                                if self._p_error_stack:
    ...
    def conditions(self):
        ...
        if (3791242477928373035, start_pos_795) in self._p_memoized:
            result, self.pos = self._p_memoized[(3791242477928373035, self.pos)]
        else:
            result = self.cond()
            self._p_memoized[(3791242477928373035, start_pos_795)] = result, self.pos
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (-826960683912196086, start_pos_796) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-826960683912196086, self.pos)]
                else:
                    result = self.COMMA()
                    self._p_memoized[(-826960683912196086, start_pos_796)] = result, self.pos
                if result is self.NoMatch:
                    ...
                    if (3791242477928373035, start_pos_797) in self._p_memoized:
                        result, self.pos = self._p_memoized[(3791242477928373035, self.pos)]
                    else:
                        result = self.cond()
                        self._p_memoized[(3791242477928373035, start_pos_797)] = result, self.pos
                    if result is self.NoMatch:
                        results_798 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def cond(self):
        ...
        if (-8118700143328859462, start_pos_802) in self._p_memoized:
            result, self.pos = self._p_memoized[(-8118700143328859462, self.pos)]
        else:
            result = self.expr()
            self._p_memoized[(-8118700143328859462, start_pos_802)] = result, self.pos
        args['left'] = result
        if result is self.NoMatch:
            ...
            if (9002684161949020702, start_pos_804) in self._p_memoized:
                result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
            else:
                result = self._()
                self._p_memoized[(9002684161949020702, start_pos_804)] = result, self.pos
            if result is self.NoMatch:
                results_816 = self.NoMatch
                self.p_restore()
                if self._p_error_stack:
                ...
                if result is self.NoMatch:
                    ...
                    if (9002684161949020702, start_pos_813) in self._p_memoized:
                        result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                    else:
                        result = self._()
                        self._p_memoized[(9002684161949020702, start_pos_813)] = result, self.pos
                    if result is self.NoMatch:
                        results_816 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
                        ...
                        if (-8118700143328859462, start_pos_814) in self._p_memoized:
                            result, self.pos = self._p_memoized[(-8118700143328859462, self.pos)]
                        else:
                            result = self.expr()
                            self._p_memoized[(-8118700143328859462, start_pos_814)] = result, self.pos
                        args['right'] = result
                        if result is self.NoMatch:
                            results_816 = self.NoMatch
                            self.p_restore()
    ...
    def assignments(self):
        ...
        if (5369830657441677753, start_pos_818) in self._p_memoized:
            result, self.pos = self._p_memoized[(5369830657441677753, self.pos)]
        else:
            result = self.assign()
            self._p_memoized[(5369830657441677753, start_pos_818)] = result, self.pos
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (-826960683912196086, start_pos_819) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-826960683912196086, self.pos)]
                else:
                    result = self.COMMA()
                    self._p_memoized[(-826960683912196086, start_pos_819)] = result, self.pos
                if result is self.NoMatch:
                    ...
                    if (5369830657441677753, start_pos_820) in self._p_memoized:
                        result, self.pos = self._p_memoized[(5369830657441677753, self.pos)]
                    else:
                        result = self.assign()
                        self._p_memoized[(5369830657441677753, start_pos_820)] = result, self.pos
                    if result is self.NoMatch:
                        results_821 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def assign(self):
        ...
        if (-4810245514585422581, start_pos_825) in self._p_memoized:
            result, self.pos = self._p_memoized[(-4810245514585422581, self.pos)]
        else:
            result = self.variable()
            self._p_memoized[(-4810245514585422581, start_pos_825)] = result, self.pos
        args['target'] = result
        if result is self.NoMatch:
            ...
            if (9002684161949020702, start_pos_827) in self._p_memoized:
                result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
            else:
                result = self._()
                self._p_memoized[(9002684161949020702, start_pos_827)] = result, self.pos
            if result is self.NoMatch:
                results_836 = self.NoMatch
                self.p_restore()
                if self._p_error_stack:
                ...
                if result is self.NoMatch:
                    ...
                    if (9002684161949020702, start_pos_833) in self._p_memoized:
                        result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                    else:
                        result = self._()
                        self._p_memoized[(9002684161949020702, start_pos_833)] = result, self.pos
                    if result is self.NoMatch:
                        results_836 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
                        ...
                        if (-8118700143328859462, start_pos_834) in self._p_memoized:
                            result, self.pos = self._p_memoized[(-8118700143328859462, self.pos)]
                        else:
                            result = self.expr()
                            self._p_memoized[(-8118700143328859462, start_pos_834)] = result, self.pos
                        args['expr'] = result
                        if result is self.NoMatch:
                            results_836 = self.NoMatch
                            self.p_restore()
    ...
    def variable(self):
        ...
        if (898397525525335440, start_pos_838) in self._p_memoized:
            result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
        else:
            result = self.NAME()
            self._p_memoized[(898397525525335440, start_pos_838)] = result, self.pos
        args['name'] = result
        if result is self.NoMatch:
            ...
            if (-3266859579204213146, start_pos_840) in self._p_memoized:
                result, self.pos = self._p_memoized[(-3266859579204213146, self.pos)]
            else:
                result = self.atloc()
                self._p_memoized[(-3266859579204213146, start_pos_840)] = result, self.pos
            result = "" if result is self.NoMatch else result
            if result is self.NoMatch:
                # print self._p_error_stack
                self._p_error_stack.pop()
        ...
        if result is self.NoMatch:
            ...
            if (-6246739521595732208, start_pos_844) in self._p_memoized:
                result, self.pos = self._p_memoized[(-6246739521595732208, self.pos)]
            else:
                result = self.LSB()
                self._p_memoized[(-6246739521595732208, start_pos_844)] = result, self.pos
            if result is self.NoMatch:
                ...
                if (898397525525335440, start_pos_845) in self._p_memoized:
                    result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
                else:
                    result = self.NAME()
                    self._p_memoized[(898397525525335440, start_pos_845)] = result, self.pos
                args['name'] = result
                if result is self.NoMatch:
                    results_852 = self.NoMatch
                    self.p_restore()
                    ...
                    if (-8759996476042128499, start_pos_847) in self._p_memoized:
                        result, self.pos = self._p_memoized[(-8759996476042128499, self.pos)]
                    else:
                        result = self.AT()
                        self._p_memoized[(-8759996476042128499, start_pos_847)] = result, self.pos
                    if result is self.NoMatch:
                        results_852 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
                        ...
                        while 42:
                            ...
                            if (-1595721882273016715, start_pos_848) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-1595721882273016715, self.pos)]
                            else:
                                result = self.neighbor()
                                self._p_memoized[(-1595721882273016715, start_pos_848)] = result, self.pos
                            if result is not self.NoMatch:
                        ...
                        if result is self.NoMatch:
                            ...
                            if (-8443923230482415639, start_pos_851) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-8443923230482415639, self.pos)]
                            else:
                                result = self.RSB()
                                self._p_memoized[(-8443923230482415639, start_pos_851)] = result, self.pos
                            if result is self.NoMatch:
                                results_852 = self.NoMatch
                                self.p_restore()
                                if self._p_error_stack:
    ...
    def atloc(self):
        ...
        if (-8759996476042128499, start_pos_855) in self._p_memoized:
            result, self.pos = self._p_memoized[(-8759996476042128499, self.pos)]
        else:
            result = self.AT()
            self._p_memoized[(-8759996476042128499, start_pos_855)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (898397525525335440, start_pos_856) in self._p_memoized:
                result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
            else:
                result = self.NAME()
                self._p_memoized[(898397525525335440, start_pos_856)] = result, self.pos
            args['name'] = result
            if result is self.NoMatch:
                # path:neighbor+
                # neighbor+
                ...
                while 42:
                    ...
                    if (-1595721882273016715, start_pos_858) in self._p_memoized:
                        result, self.pos = self._p_memoized[(-1595721882273016715, self.pos)]
                    else:
                        result = self.neighbor()
                        self._p_memoized[(-1595721882273016715, start_pos_858)] = result, self.pos
                    if result is not self.NoMatch:
    ...
    def expr(self):
        ...
        if (-215329052412314081, start_pos_864) in self._p_memoized:
            result, self.pos = self._p_memoized[(-215329052412314081, self.pos)]
        else:
            result = self.term()
            self._p_memoized[(-215329052412314081, start_pos_864)] = result, self.pos
        args['first'] = result
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if result is self.NoMatch:
                    ...
                    if (-215329052412314081, start_pos_867) in self._p_memoized:
                        result, self.pos = self._p_memoized[(-215329052412314081, self.pos)]
                    else:
                        result = self.term()
                        self._p_memoized[(-215329052412314081, start_pos_867)] = result, self.pos
                    if result is self.NoMatch:
                        results_868 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def term(self):
        ...
        if (2215869652902755134, start_pos_873) in self._p_memoized:
            result, self.pos = self._p_memoized[(2215869652902755134, self.pos)]
        else:
            result = self.fact()
            self._p_memoized[(2215869652902755134, start_pos_873)] = result, self.pos
        args['first'] = result
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if result is self.NoMatch:
                    ...
                    if (2215869652902755134, start_pos_876) in self._p_memoized:
                        result, self.pos = self._p_memoized[(2215869652902755134, self.pos)]
                    else:
                        result = self.fact()
                        self._p_memoized[(2215869652902755134, start_pos_876)] = result, self.pos
                    if result is self.NoMatch:
                        results_877 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def fact(self):
        ...
        if (-3925783393829827877, start_pos_882) in self._p_memoized:
            result, self.pos = self._p_memoized[(-3925783393829827877, self.pos)]
        else:
            result = self.LP()
            self._p_memoized[(-3925783393829827877, start_pos_882)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (-8118700143328859462, start_pos_883) in self._p_memoized:
                result, self.pos = self._p_memoized[(-8118700143328859462, self.pos)]
            else:
                result = self.expr()
                self._p_memoized[(-8118700143328859462, start_pos_883)] = result, self.pos
            args['fact'] = result
            if result is self.NoMatch:
                results_886 = self.NoMatch
                self.p_restore()
                ...
                if (-524458831725247941, start_pos_885) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-524458831725247941, self.pos)]
                else:
                    result = self.RP()
                    self._p_memoized[(-524458831725247941, start_pos_885)] = result, self.pos
                if result is self.NoMatch:
                    results_886 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
        ...
        if result is self.NoMatch:
            ...
            if (4031435127966617166, start_pos_887) in self._p_memoized:
                result, self.pos = self._p_memoized[(4031435127966617166, self.pos)]
            else:
                result = self.atom()
                self._p_memoized[(4031435127966617166, start_pos_887)] = result, self.pos
            args['fact'] = result
            if result is self.NoMatch:
                pass
        if result is self.NoMatch:
    ...
    def atom(self):
        ...
        if (-9066087360609002440, start_pos_891) in self._p_memoized:
            result, self.pos = self._p_memoized[(-9066087360609002440, self.pos)]
        else:
            result = self.NUMBER()
            self._p_memoized[(-9066087360609002440, start_pos_891)] = result, self.pos
        if result is self.NoMatch:
            start_pos_892= self.pos
            if (-4810245514585422581, start_pos_892) in self._p_memoized:
                result, self.pos = self._p_memoized[(-4810245514585422581, self.pos)]
            else:
                result = self.variable()
                self._p_memoized[(-4810245514585422581, start_pos_892)] = result, self.pos
            if result is self.NoMatch:
                pass
        if result is self.NoMatch:
            self.p_restore()
    ...
    def neighbor(self):
        ...
        if (9002684161949020702, start_pos_896) in self._p_memoized:
            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
        else:
            result = self._()
            self._p_memoized[(9002684161949020702, start_pos_896)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_899) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_899)] = result, self.pos
                if result is self.NoMatch:
                    results_910 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
                    ...
                    if (1497034522734204538, start_pos_900) in self._p_memoized:
                        result, self.pos = self._p_memoized[(1497034522734204538, self.pos)]
                    else:
                        result = self.lblmatch()
                        self._p_memoized[(1497034522734204538, start_pos_900)] = result, self.pos
                    result = "" if result is self.NoMatch else result
                    if result is self.NoMatch:
                        # print self._p_error_stack
                        self._p_error_stack.pop()
                    ...
                    if result is self.NoMatch:
                        ...
                        if (898397525525335440, start_pos_903) in self._p_memoized:
                            result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
                        else:
                            result = self.NAME()
                            self._p_memoized[(898397525525335440, start_pos_903)] = result, self.pos
                        if result is self.NoMatch:
                            start_pos_904= self.pos
                            if (-807930556499607918, start_pos_904) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-807930556499607918, self.pos)]
                            else:
                                result = self.STAR()
                                self._p_memoized[(-807930556499607918, start_pos_904)] = result, self.pos
                            if result is self.NoMatch:
                                pass
                        if result is self.NoMatch:
                            self.p_restore()
                        ...
                        if result is self.NoMatch:
                            ...
                            if (1497034522734204538, start_pos_907) in self._p_memoized:
                                result, self.pos = self._p_memoized[(1497034522734204538, self.pos)]
                            else:
                                result = self.lblmatch()
                                self._p_memoized[(1497034522734204538, start_pos_907)] = result, self.pos
                            result = "" if result is self.NoMatch else result
                            if result is self.NoMatch:
                                # print self._p_error_stack
                                self._p_error_stack.pop()
    ...
    def lblmatch(self):
        ...
        if (8940689054090519499, start_pos_912) in self._p_memoized:
            result, self.pos = self._p_memoized[(8940689054090519499, self.pos)]
        else:
            result = self.LCB()
            self._p_memoized[(8940689054090519499, start_pos_912)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (9002970063058209709, start_pos_913) in self._p_memoized:
                result, self.pos = self._p_memoized[(9002970063058209709, self.pos)]
            else:
                result = self.lblexpr()
                self._p_memoized[(9002970063058209709, start_pos_913)] = result, self.pos
            args['expr'] = result
            if result is self.NoMatch:
                results_916 = self.NoMatch
                self.p_restore()
                ...
                if (5069023775497208902, start_pos_915) in self._p_memoized:
                    result, self.pos = self._p_memoized[(5069023775497208902, self.pos)]
                else:
                    result = self.RCB()
                    self._p_memoized[(5069023775497208902, start_pos_915)] = result, self.pos
                if result is self.NoMatch:
                    results_916 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
    ...
    def lblexpr(self):
        ...
        if (-2387993120455526500, start_pos_918) in self._p_memoized:
            result, self.pos = self._p_memoized[(-2387993120455526500, self.pos)]
        else:
            result = self.lblterm()
            self._p_memoized[(-2387993120455526500, start_pos_918)] = result, self.pos
        args['first'] = result
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (9002684161949020702, start_pos_920) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_920)] = result, self.pos
                if result is self.NoMatch:
                    ...
                    if result is self.NoMatch:
                        ...
                        if (9002684161949020702, start_pos_922) in self._p_memoized:
                            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                        else:
                            result = self._()
                            self._p_memoized[(9002684161949020702, start_pos_922)] = result, self.pos
                        if result is self.NoMatch:
                            results_924 = self.NoMatch
                            self.p_restore()
                            if self._p_error_stack:
                            ...
                            if (-2387993120455526500, start_pos_923) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-2387993120455526500, self.pos)]
                            else:
                                result = self.lblterm()
                                self._p_memoized[(-2387993120455526500, start_pos_923)] = result, self.pos
                            if result is self.NoMatch:
                                results_924 = self.NoMatch
                                self.p_restore()
                                if self._p_error_stack:
    ...
    def lblterm(self):
        ...
        if (383458513248756477, start_pos_929) in self._p_memoized:
            result, self.pos = self._p_memoized[(383458513248756477, self.pos)]
        else:
            result = self.lblfact()
            self._p_memoized[(383458513248756477, start_pos_929)] = result, self.pos
        args['first'] = result
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (9002684161949020702, start_pos_931) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_931)] = result, self.pos
                if result is self.NoMatch:
                    ...
                    if result is self.NoMatch:
                        ...
                        if (9002684161949020702, start_pos_933) in self._p_memoized:
                            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                        else:
                            result = self._()
                            self._p_memoized[(9002684161949020702, start_pos_933)] = result, self.pos
                        if result is self.NoMatch:
                            results_935 = self.NoMatch
                            self.p_restore()
                            if self._p_error_stack:
                            ...
                            if (-2387993120455526500, start_pos_934) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-2387993120455526500, self.pos)]
                            else:
                                result = self.lblterm()
                                self._p_memoized[(-2387993120455526500, start_pos_934)] = result, self.pos
                            if result is self.NoMatch:
                                results_935 = self.NoMatch
                                self.p_restore()
                                if self._p_error_stack:
    ...
    def lblfact(self):
        ...
        if (-7511513647574346171, start_pos_940) in self._p_memoized:
            result, self.pos = self._p_memoized[(-7511513647574346171, self.pos)]
        else:
            result = self.TILDA()
            self._p_memoized[(-7511513647574346171, start_pos_940)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (383458513248756477, start_pos_941) in self._p_memoized:
                result, self.pos = self._p_memoized[(383458513248756477, self.pos)]
            else:
                result = self.lblfact()
                self._p_memoized[(383458513248756477, start_pos_941)] = result, self.pos
            args['neg'] = result
            if result is self.NoMatch:
                results_943 = self.NoMatch
                self.p_restore()
        ...
        if result is self.NoMatch:
            ...
            if (-3925783393829827877, start_pos_944) in self._p_memoized:
                result, self.pos = self._p_memoized[(-3925783393829827877, self.pos)]
            else:
                result = self.LP()
                self._p_memoized[(-3925783393829827877, start_pos_944)] = result, self.pos
            if result is self.NoMatch:
                ...
                if (9002970063058209709, start_pos_945) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002970063058209709, self.pos)]
                else:
                    result = self.lblexpr()
                    self._p_memoized[(9002970063058209709, start_pos_945)] = result, self.pos
                args['sub'] = result
                if result is self.NoMatch:
                    results_948 = self.NoMatch
                    self.p_restore()
                    ...
                    if (-524458831725247941, start_pos_947) in self._p_memoized:
                        result, self.pos = self._p_memoized[(-524458831725247941, self.pos)]
                    else:
                        result = self.RP()
                        self._p_memoized[(-524458831725247941, start_pos_947)] = result, self.pos
                    if result is self.NoMatch:
                        results_948 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
            ...
            if result is self.NoMatch:
                ...
                if (7368162533318854580, start_pos_949) in self._p_memoized:
                    result, self.pos = self._p_memoized[(7368162533318854580, self.pos)]
                else:
                    result = self.arg()
                    self._p_memoized[(7368162533318854580, start_pos_949)] = result, self.pos
                args['atom'] = result
                if result is self.NoMatch:
                    pass
        if result is self.NoMatch:
    ...
    def instance(self):
        ...
        if (898397525525335440, start_pos_953) in self._p_memoized:
            result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
        else:
            result = self.NAME()
            self._p_memoized[(898397525525335440, start_pos_953)] = result, self.pos
        args['name'] = result
        if result is self.NoMatch:
            ...
            if (-261095102150264832, start_pos_955) in self._p_memoized:
                result, self.pos = self._p_memoized[(-261095102150264832, self.pos)]
            else:
                result = self.labels()
                self._p_memoized[(-261095102150264832, start_pos_955)] = result, self.pos
            result = "" if result is self.NoMatch else result
            if result is self.NoMatch:
                # print self._p_error_stack
                self._p_error_stack.pop()
            ...
            if result is self.NoMatch:
                ...
                if (9002684161949020702, start_pos_958) in self._p_memoized:
                    result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                else:
                    result = self._()
                    self._p_memoized[(9002684161949020702, start_pos_958)] = result, self.pos
                if result is self.NoMatch:
                    results_969 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
                    ...
                    if result is self.NoMatch:
                        ...
                        if (9002684161949020702, start_pos_960) in self._p_memoized:
                            result, self.pos = self._p_memoized[(9002684161949020702, self.pos)]
                        else:
                            result = self._()
                            self._p_memoized[(9002684161949020702, start_pos_960)] = result, self.pos
                        if result is self.NoMatch:
                            results_969 = self.NoMatch
                            self.p_restore()
                            if self._p_error_stack:
                            ...
                            if (898397525525335440, start_pos_961) in self._p_memoized:
                                result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
                            else:
                                result = self.NAME()
                                self._p_memoized[(898397525525335440, start_pos_961)] = result, self.pos
                            args['location'] = result
                            if result is self.NoMatch:
                                results_969 = self.NoMatch
                                self.p_restore()
                                ...
                                if (-3925783393829827877, start_pos_963) in self._p_memoized:
                                    result, self.pos = self._p_memoized[(-3925783393829827877, self.pos)]
                                else:
                                    result = self.LP()
                                    self._p_memoized[(-3925783393829827877, start_pos_963)] = result, self.pos
                                if result is self.NoMatch:
                                    results_969 = self.NoMatch
                                    self.p_restore()
                                    if self._p_error_stack:
                                    ...
                                    if (7561541381562460085, start_pos_964) in self._p_memoized:
                                        result, self.pos = self._p_memoized[(7561541381562460085, self.pos)]
                                    else:
                                        result = self.arguments()
                                        self._p_memoized[(7561541381562460085, start_pos_964)] = result, self.pos
                                    result = "" if result is self.NoMatch else result
                                    if result is self.NoMatch:
                                        # print self._p_error_stack
                                        self._p_error_stack.pop()
                                    ...
                                    if result is self.NoMatch:
                                        ...
                                        if (-524458831725247941, start_pos_967) in self._p_memoized:
                                            result, self.pos = self._p_memoized[(-524458831725247941, self.pos)]
                                        else:
                                            result = self.RP()
                                            self._p_memoized[(-524458831725247941, start_pos_967)] = result, self.pos
                                        if result is self.NoMatch:
                                            results_969 = self.NoMatch
                                            self.p_restore()
                                            if self._p_error_stack:
                                            ...
                                            if (4012084833292409859, start_pos_968) in self._p_memoized:
                                                result, self.pos = self._p_memoized[(4012084833292409859, self.pos)]
                                            else:
                                                result = self.NL()
                                                self._p_memoized[(4012084833292409859, start_pos_968)] = result, self.pos
                                            if result is self.NoMatch:
                                                results_969 = self.NoMatch
                                                self.p_restore()
                                                if self._p_error_stack:
    ...
    def graph(self):
        ...
        if (5126587405508914005, start_pos_971) in self._p_memoized:
            result, self.pos = self._p_memoized[(5126587405508914005, self.pos)]
        else:
            result = self.subg()
            self._p_memoized[(5126587405508914005, start_pos_971)] = result, self.pos
        args['first'] = result
        if result is self.NoMatch:
            ...
            while 42:
                ...
                if (-7666743646980731735, start_pos_973) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-7666743646980731735, self.pos)]
                else:
                    result = self.edge()
                    self._p_memoized[(-7666743646980731735, start_pos_973)] = result, self.pos
                result = "" if result is self.NoMatch else result
                if result is self.NoMatch:
                    # print self._p_error_stack
                    self._p_error_stack.pop()
                if result is self.NoMatch:
                    ...
                    if (5126587405508914005, start_pos_975) in self._p_memoized:
                        result, self.pos = self._p_memoized[(5126587405508914005, self.pos)]
                    else:
                        result = self.subg()
                        self._p_memoized[(5126587405508914005, start_pos_975)] = result, self.pos
                    if result is self.NoMatch:
                        results_976 = self.NoMatch
                        self.p_restore()
                        if self._p_error_stack:
    ...
    def subg(self):
        ...
        if (-3723815232261156341, start_pos_981) in self._p_memoized:
            result, self.pos = self._p_memoized[(-3723815232261156341, self.pos)]
        else:
            result = self.__()
            self._p_memoized[(-3723815232261156341, start_pos_981)] = result, self.pos
        if result is self.NoMatch:
            ...
            if (898397525525335440, start_pos_982) in self._p_memoized:
                result, self.pos = self._p_memoized[(898397525525335440, self.pos)]
            else:
                result = self.NAME()
                self._p_memoized[(898397525525335440, start_pos_982)] = result, self.pos
            args['node'] = result
            if result is self.NoMatch:
                results_985 = self.NoMatch
                self.p_restore()
                ...
                if (-3723815232261156341, start_pos_984) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-3723815232261156341, self.pos)]
                else:
                    result = self.__()
                    self._p_memoized[(-3723815232261156341, start_pos_984)] = result, self.pos
                if result is self.NoMatch:
                    results_985 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
        ...
        if result is self.NoMatch:
            ...
            if (-3723815232261156341, start_pos_986) in self._p_memoized:
                result, self.pos = self._p_memoized[(-3723815232261156341, self.pos)]
            else:
                result = self.__()
                self._p_memoized[(-3723815232261156341, start_pos_986)] = result, self.pos
            if result is self.NoMatch:
                ...
                if result is self.NoMatch:
                    ...
                    if (-185500931860644373, start_pos_988) in self._p_memoized:
                        result, self.pos = self._p_memoized[(-185500931860644373, self.pos)]
                    else:
                        result = self.graph()
                        self._p_memoized[(-185500931860644373, start_pos_988)] = result, self.pos
                    args['sub'] = result
                    if result is self.NoMatch:
                        results_992 = self.NoMatch
                        self.p_restore()
                        ...
                        if result is self.NoMatch:
                            ...
                            if (-3723815232261156341, start_pos_991) in self._p_memoized:
                                result, self.pos = self._p_memoized[(-3723815232261156341, self.pos)]
                            else:
                                result = self.__()
                                self._p_memoized[(-3723815232261156341, start_pos_991)] = result, self.pos
                            if result is self.NoMatch:
                                results_992 = self.NoMatch
                                self.p_restore()
                                if self._p_error_stack:
    ...
    def edge(self):
        ...
        if (2124761782373197597, start_pos_995) in self._p_memoized:
            result, self.pos = self._p_memoized[(2124761782373197597, self.pos)]
        else:
            result = self.ARC()
            self._p_memoized[(2124761782373197597, start_pos_995)] = result, self.pos
        args['left'] = result
        if result is self.NoMatch:
            ...
            if (7561541381562460085, start_pos_997) in self._p_memoized:
                result, self.pos = self._p_memoized[(7561541381562460085, self.pos)]
            else:
                result = self.arguments()
                self._p_memoized[(7561541381562460085, start_pos_997)] = result, self.pos
            result = "" if result is self.NoMatch else result
            if result is self.NoMatch:
                # print self._p_error_stack
                self._p_error_stack.pop()
            ...
            if result is self.NoMatch:
                ...
                if (2124761782373197597, start_pos_1000) in self._p_memoized:
                    result, self.pos = self._p_memoized[(2124761782373197597, self.pos)]
                else:
                    result = self.ARC()
                    self._p_memoized[(2124761782373197597, start_pos_1000)] = result, self.pos
                args['right'] = result
                if result is self.NoMatch:
                    results_1002 = self.NoMatch
                    self.p_restore()
    ...
    def ARC(self):
        ...
        if (-3723815232261156341, start_pos_1004) in self._p_memoized:
            result, self.pos = self._p_memoized[(-3723815232261156341, self.pos)]
        else:
            result = self.__()
            self._p_memoized[(-3723815232261156341, start_pos_1004)] = result, self.pos
        if result is self.NoMatch:
            ...
            if result is self.NoMatch:
                ...
                if (-3723815232261156341, start_pos_1007) in self._p_memoized:
                    result, self.pos = self._p_memoized[(-3723815232261156341, self.pos)]
                else:
                    result = self.__()
                    self._p_memoized[(-3723815232261156341, start_pos_1007)] = result, self.pos
                if result is self.NoMatch:
                    results_1008 = self.NoMatch
                    self.p_restore()
                    if self._p_error_stack:
